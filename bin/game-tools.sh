...
CLASS_PATH="${IDE_HOME}/lib/platform-loader.jar:${IDE_HOME}/lib/util.jar:${IDE_HOME}/lib/app.jar:${IDE_HOME}/lib/util-8.jar:${IDE_HOME}/lib/util_rt.jar:${IDE_HOME}/lib/jps-model.jar:${IDE_HOME}/lib/stats.jar:${IDE_HOME}/lib/protobuf.jar:${IDE_HOME}/lib/external-system-rt.jar:${IDE_HOME}/lib/intellij-test-discovery.jar:${IDE_HOME}/lib/forms_rt.jar:${IDE_HOME}/lib/rd.jar:${IDE_HOME}/lib/externalProcess-rt.jar:${IDE_HOME}/lib/annotations-java5.jar:${IDE_HOME}/lib/annotations.jar:${IDE_HOME}/lib/bouncy-castle.jar:${IDE_HOME}/lib/byte-buddy-agent.jar:${IDE_HOME}/lib/error-prone-annotations.jar:${IDE_HOME}/lib/groovy.jar:${IDE_HOME}/lib/grpc.jar:${IDE_HOME}/lib/idea_rt.jar:${IDE_HOME}/lib/intellij-coverage-agent-1.0.723.jar:${IDE_HOME}/lib/junit4.jar:${IDE_HOME}/lib/lib.jar:${IDE_HOME}/lib/resources.jar:${IDE_HOME}/lib/ant/lib/ant.jar:${IDE_HOME}/plugins/android/lib/*:${IDE_HOME}/plugins/android/resources/*:${IDE_HOME}/plugins/java/lib/java-api.jar:${IDE_HOME}/plugins/java/lib/java-impl.jar:${IDE_HOME}/plugins/java/lib/resources.jar:${IDE_HOME}/plugins/java/lib/java_resources_en.jar"
